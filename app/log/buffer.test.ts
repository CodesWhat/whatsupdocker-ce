...
describe('Ring Buffer', () => {
    ...
    describe('combined filters', () => {
        test('should apply level + component + since filters together', () => {
            addEntry(makeEntry({ level: 'debug', component: 'api', timestamp: 1000, msg: 'old-debug-api' }));
            addEntry(makeEntry({ level: 'warn', component: 'api', timestamp: 2000, msg: 'old-warn-api' }));
            addEntry(makeEntry({ level: 'warn', component: 'api', timestamp: 5000, msg: 'new-warn-api' }));
            addEntry(makeEntry({ level: 'warn', component: 'watcher', timestamp: 5000, msg: 'new-warn-watcher' }));
            addEntry(makeEntry({ level: 'error', component: 'api', timestamp: 6000, msg: 'new-error-api' }));
