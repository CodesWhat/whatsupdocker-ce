...
describe('agent API event', () => {
    ...
    describe('initEvents', () => {
        test('should register container event listeners', () => {
            eventApi.initEvents();
            expect(event.registerContainerAdded).toHaveBeenCalledWith(
                expect.any(Function),
            );
            expect(event.registerContainerUpdated).toHaveBeenCalledWith(
                expect.any(Function),
            );
            expect(event.registerContainerRemoved).toHaveBeenCalledWith(
                expect.any(Function),
            );
        });
